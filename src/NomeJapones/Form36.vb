Public Class Form36
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Dim frase As String
        FileOpen(1, "arquivos_jp\verbos.jp", OpenMode.Input)
        Do Until contagem = 0
            Input(1, frase)
            Label1.Text = frase
            contagem = contagem - 1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Label1.Text = "" Then
            MsgBox("Primeiro escreva algum verbo!", MsgBoxStyle.OkOnly, "JapaneseWay")
        Else
            ...
            ElseIf TextBox1.Text = "" Then
                MsgBox("Primeiro escreva uma verbo em escrita romanizada.", MsgBoxStyle.OkOnly, "JapaneseWay")
            Else
    ...
    Private Sub Button2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If particula = "" Then
            MsgBox("Primeiro escreva um verbo!", MsgBoxStyle.OkOnly, "JapaneseWay")
        Else
            MsgBox("O verbo correto é: " & particula & ".", MsgBoxStyle.OkOnly, "JapaneseWay")
        End If
    End Sub
